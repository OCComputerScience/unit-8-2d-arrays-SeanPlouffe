...
public class Main
{
    public static void main(String[] args)
    {
        ...
        updateValue(nums, 0, nums[0].length-1, nums[nums.length-1].length);
        ...
        updateValue(nums, 0, nums[0].length-1, nums[0][0] + nums[nums.length-1][nums[nums.length-1].length-1]);
